...
ResponseCoeff[SigmaPPJ]=Table[
        ...
        +1/4 cvector[iiFF][[10]]cvector[jjFF][[10]]q^2,{iiFF,2},{jjFF,2}];
...
ResponseCoeff[SigmaPJ]=Table[
        ...
        +1/8 (
            cvector[iiFF][[3]]cvector[jjFF][[3]]q^2
            +cvector[iiFF][[7]]cvector[jjFF][[7]]
        )(v^2-q^2/(4(\[Mu]T[mchi,M])^2)),{iiFF,2},{jjFF,2}];
...
ResponseCoeff[DeltaJ]=Table[
    ...
    +2 q^2/mN^2 cvector[iiFF][[2]]cvector[jjFF][[2]](v^2-q^2/(4(\[Mu]T[mchi,M])^2)),{iiFF,2},{jjFF,2}];

ResponseCoeff[PhiPPJ]=Table[
    q^2/(16mN^2) Cl[jchi](
        cvector[iiFF][[12]]
        -cvector[iiFF][[15]]q^2
    )(cvector[jjFF][[12]]-cvector[jjFF][[15]]q^2)
    +q^4/(4mN^2)cvector[iiFF][[3]]cvector[jjFF][[3]],{iiFF,2},{jjFF,2}];
...
ResponseCoeff[MJ,PhiPPJ]=Table[i
    q^2/(4mN)Cl[jchi]cvector[iiFF][[11]](cvector[jjFF][[12]]-cvector[jjFF][[15]]q^2)
    +q^2/(mN)cvector[jjFF][[3]](cvector[iiFF][[1]]+cvector[iiFF][[2]](v^2-q^2/(4(\[Mu]T[mchi,M])^2))),{iiFF,2},{jjFF,2}];
...
ResponseCoeff[SigmaPJ,DeltaJ]=Table[
    ...
    -q^2/(mN)cvector[jjFF][[2]]cvector[iiFF][[3]](v^2-q^2/(4(\[Mu]T[mchi,M])^2)),{iiFF,2},{jjFF,2}];
